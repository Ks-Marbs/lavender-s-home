...
func _process(delta: float) -> void:
	...
	if $lan.item_selected:
		...
		$Stats.text = (["Stats","Status","𐑕𐑑𐑨𐑑𐑕","Estadísticas","Statistiques","Tilastot","⠠⠎⠞⠁⠞⠎"])[Global.lang]
		...
		$r.text = (["Retry","Reiniciar","𐑮𐑰𐑑𐑮𐑲","Reintentar","Réessayer","Yritä uudelleen","⠠⠗⠑⠞⠗⠽"])[Global.lang]
		$quit.text = (["Quit","Quitar","𐑒𐑢𐑦𐑑","Salir","Quitter","Poistu","⠠⠟⠥⠊⠞"])[Global.lang]
		$back.text = (["Back","Voltar","𐑚𐑨𐑒","Vuelta","Reculer","Takaisin","⠠⠃⠁⠉⠅"])[Global.lang]
		$Allstats.text = (["Health:","Saúde:","𐑣𐑧𐑤𐑔:","Salud:","Santé :","Terveys:","⠠⠓⠑⠁⠇⠞⠓⠒"])[Global.lang]+str(Global.health)+(["\n Hunger:","\n Fome:","\n 𐑣𐑳𐑙𐑜𐑼:","\n Hambre:","\n Faim :","\n Nälkä:","\n ⠠⠓⠥⠝⠛⠑⠗⠒"])[Global.lang]+str(Global.hunger)+(["\n Hydration:","\n Hidratação:","\n 𐑣𐑲𐑛𐑮𐑱𐑖𐑩𐑯:","\n Hidratación:","\n Hydratation :","\n Nesteytys:","\n ⠠⠓⠽⠙⠗⠁⠞⠊⠕⠝⠒"])[Global.lang]+str(Global.water)+(["\n Sleepiness:","\n Sono:","\n 𐑕𐑤𐑰𐑐𐑯𐑧𐑕:","\n Sueño:","\n Sommeil :","\n Unisuus:","\n ⠠⠎⠇⠑⠑⠏⠊⠝⠑⠎⠎⠒"])[Global.lang]+str(Global.sleep)
