...
[[2], [3,1,"2-0",0,2],[3,3,"2-1",0,3],[3,4,"2-2",0,4],[2,5,"2-3",0,5],[2,4,"2-4",0,6],[3,3,"2-5",0,7],[3,4,"2-6",0,8],[2,4,"2-7",0,9],[2,4,"2-8",0,10],[3,3,"2-9",0,11],[3,5,"2-10",0,12],[2,5,"2-11",0,13],[2,3,"2-12",0,14],[3,4,"2-13",0,15],[3,3,"2-14",0,16],[2,3,"2-15",0,17],[3,3,"2-16",0,18],[2,4,"2-17",0,19],[6,4,"2-18",0,0],["E",0]],
[[3],[5,1,"3-0",0,2],[5,1,"3-1",0,3],[2,3,"3-2",0,4],[0,2,"w1",0,5],[2,1,"3-3",0,6],[2,4,"3-4",0,7],[0,5,"dots",0,8],[2,5,"3-5",0,9],[5,0,'',2,"y3",10,"w2",13],[0,5,"y1",0,11],[2,5,"3-6",0,12],[0,5,"y2",0,0],[0,1,"3-7",0,14],[2,4,"3-8",0,15],[0,1,"dots",0,16],[2,2,"3-9",0,0],["E",0]],
[[4],[4,0,"4-0",0,2],[7,0,"4-1",0,3],[7,3,"4-2",0,4],[4,1,"4-3",0,5],[4,2,"4-4",0,6],[7,1,"4-5",0,7],[4,2,"ok",0,0],["E",0]]

]

#charactres : 0-lav eep 1-soap 2-WB 3- Petal 4-lav 5-narrator 6-idk 7-Char 8-Soap eep
...
func prepare(n):
	...
	match Global.storystep:
		0: Soap=[0,50,50,50,50,50,50,0,100,100,100,100];Winterblush=[0,50,50,50,50,50,50,0,0,0,100,100,100,100];Petal=[1,50,50,50,50,15,24,1,0,0,100,100,100,100]
