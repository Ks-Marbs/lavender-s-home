...
[[0] , ["B",load("res://images/slash0.png"),3,3,3,['"My poor wilted flowers..."','"Minhas pobres flores..."','"𐑥𐑲 𐑐𐑫𐑼 𐑢𐑦𐑤𐑑𐑦𐑛 𐑓𐑤𐑬𐑼𐑟..."']],["A",load("res://images/slash0.png"),0.2,4],["A",load("res://images/slash1.png"),0.3,4],["A",load("res://images/slash2.png"),0.15,5],["A",load("res://images/slash3.png"),0.15,6],["A",load("res://images/slash4.png"),0.15,7],["A",load("res://images/slash5.png"),0.15,8],["A",load("res://images/slash6.png"),0.15,9],["A",load("res://images/slash7.png"),0.15,10],["A",load("res://images/slash8.png"),0.15,11],["A",load("res://images/slash9.png"),0.15,12],["A",load("res://images/slash10.png"),0,13], [5,0,['You are in your bedroom, you are ok, just pretty scared...maybe you should check on Soap.','"Você está no seu quarto, está tudo bem, só um pouco assustada... Talvez devesse olhar como seu irmão está."','"𐑿 𐑸 𐑦𐑯 𐑘𐑹 𐑚𐑧𐑛𐑮𐑵𐑥, 𐑿 𐑸 𐑴𐑒𐑱, 𐑡𐑳𐑕𐑑 𐑐𐑮𐑦𐑑𐑦 𐑕𐑒𐑺𐑛. 𐑥𐑱𐑚𐑰 𐑿 𐑖𐑫𐑛 𐑗𐑧𐑒 𐑪𐑯 𐑕𐑴𐑐"'],0,0]],\
